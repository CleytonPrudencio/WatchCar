...
const handleLogin = async (event) => {
  ...
  await authService
    ...
    .then((response) => {
      ...
      const decode = jwtDecode(token); // Decodifica o token para verificar se é válido
      console.log('Token decodificado:', decode.sub);
      console.log('Token expire:', decode.exp);
      console.log('Token expire:', decode.name);
